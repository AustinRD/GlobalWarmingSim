...
public class DataHolder
{
    ...
    static public Region[] regions = {
            new Region("West", Region.DEFAULT_WEST_POP, sim),
            new Region("Midwest", Region.DEFAULT_MIDWEST_POP, sim),
            new Region("South", Region.DEFAULT_SOUTH_POP, sim),
            new Region("East", Region.DEFAULT_EAST_POP, sim),
    };

    static public Event[] events = new Event[32];

//    public static Event[] initEvents(Simulator s) {
//        Event[] events = DataHolder.events;
//        /*
...
//        events[0].preText = "America's people and industries need energy. Coal will provide an immediate boost, but investing in renewables might pay off in the long run.";
//
...
//        events[19].text = "It came from the earth, so it must go back. No extra work required, right?";
//
